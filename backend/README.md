...
## Project Structure
    ...
    ├── testprdgroup_dev_37389  # Django project configurations
...
1. Clone this repo and `cd testprdgroup_dev_37389`
...
2. Clone this repo and `cd testprdgroup_dev_37389`
